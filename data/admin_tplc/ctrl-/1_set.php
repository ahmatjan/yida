...
<div class="table" style="display:none">
	...
	<tr>
		...
		<td>&nbsp;内容管理&nbsp;</td>
		<td><input type="radio" name="ctrl_init" value="<?php echo $rs[ctrl_init];?>" id="ctrl_init_user" onclick="ctrl_set('user')"></td>
		<td>&nbsp;自定义&nbsp;</td>
		<td id="ctrl_init_input"><input type="text" name="ctrl_init_val" value="<?php echo $rs[ctrl_init];?>" class="short_input"></td>
