...
<div class="InWarpBox">
  <div class="HeaderBox">
    <div class="HeaderLog">
      <a href="index.php">
        <img src="<?php echo $_sys['siteurl'];?><?php echo $rs['thumb']['files']['filename'];?>" width="251" height="70" ></a>
    </div>
    <div class="TopYuLink">
...
<div class="MainBox">
  <div class="MainTit">
    <div style=" float:left;"><?php echo $rs['title'];?></div>
    <div style="font-size:16px; line-height:110px; float:left;">&nbsp;中国创意控股附属机构</div>
  </div>
  <div class="MainMid">
    <div class="LeftZ">
      <img src="<?php echo $_sys['siteurl'];?>tpl/www/images/leftz.png" width="91" height="82" ></div>
    <div class="RighZ">
      <img src="<?php echo $_sys['siteurl'];?>tpl/www/images/righz.png" width="86" height="84" ></div>
    <div class="MainMidTop">
      <img src="<?php echo $_sys['siteurl'];?>tpl/www/images/mainbg_top.png" width="1007" height="55" ></div>
    ...
    <div class="MainMidBot">
      <img src="<?php echo $_sys['siteurl'];?>tpl/www/images/mainbg_bot.png" width="1007" height="109" ></div>
  </div>
</div>
<div class="CopyIndex">
