...
<head>
	...
	<link href="<?php echo $_sys['siteurl'];?>tpl/tc/css/chuangyistyle_1.css" type="text/css" rel="stylesheet" >
	<script type="text/javascript" src="<?php echo $_sys['siteurl'];?>tpl/tc/js/jquery-1.9.1.min_1.js"></script>
	<script type="text/javascript" src="<?php echo $_sys['siteurl'];?>tpl/tc/js/common_1.js"></script>
	<script type="text/javascript" src="<?php echo $_sys['siteurl'];?>tpl/tc/js/jquery.nanoscroller_1.js"></script>